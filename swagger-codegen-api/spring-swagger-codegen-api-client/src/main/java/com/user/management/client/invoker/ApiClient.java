package com.user.management.client.invoker;
...
import com.user.management.client.invoker.auth.Authentication;
import com.user.management.client.invoker.auth.HttpBasicAuth;
import com.user.management.client.invoker.auth.ApiKeyAuth;
import com.user.management.client.invoker.auth.OAuth;

@Component("com.user.management.client.invoker.ApiClient")
